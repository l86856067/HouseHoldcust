 ...
 * 修改记录：
 */
public class ResultSuccessDialog extends Dialog {
    ...
    public ResultSuccessDialog(Context context) {
        super(context,R.style.dialog_notice);
        this.context = context;
    }

    public ResultSuccessDialog setMessage(String message){
        this.message = message;
        return this;
    }

    public ResultSuccessDialog setPostButton(String postText, OnpostButtonInterface onpostButtonInterface){
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.dialog_result_success, null);
        setContentView(view);

        TextView textmessage = (TextView) view.findViewById(R.id.dialog_success_message);
        TextView btn = (TextView) view.findViewById(R.id.dialog_success_btn);
